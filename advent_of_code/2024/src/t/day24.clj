...
(defn find-smaller-diff
  ...
  (let [[op1 c1 a1 b1] f1
    ...
    (cond (not= op1 op2) [f1 f2]
          (= a1 a2) [find-smaller-diff b1 b2]
          (= a1 b2) [find-smaller-diff b1 a2]
          (= b1 a2) [find-smaller-diff a1 b2]
          (= b1 b2) [find-smaller-diff a1 a2]
          :else [f1 f2])))
